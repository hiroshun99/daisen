...
async function createSql(): Promise<Sql> {
  ...
  if (dbSource === "pglite" && process.env.VERCEL) {
    throw new Error(
      "DATABASE_URL or POSTGRES_URL is required on Vercel. Connect Neon to this project and redeploy.",
    );
  }
...
// Node. Skip the PGLite path on Vercel — it cannot persist there.
