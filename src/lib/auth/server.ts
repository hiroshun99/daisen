...
import { databaseUrlFromEnv } from "../env.server";
...
// Public Vercel hosts so email/password works outside grok.me.
const PUBLIC_HOSTS: string[] = ["*.vercel.app"];
const PUBLIC_ORIGINS: string[] = PUBLIC_HOSTS.map((host) => `https://${host}`);
...
const trustedOrigins: string[] = explicitBaseURL
  ? [explicitBaseURL, ...PUBLIC_ORIGINS, ...PUBLIC_HOSTS, ...LOCAL_DEV_ORIGINS]
  : [
